...
namespace SmartPOS.Forms.RestaurantForms
{
    public partial class CashPayment : Form
    {
        ...
        public CashPayment(InvoiceBillDetails invoiceDetails, DataTable dt)
        {
            InitializeComponent();
            SetReferences();
            SetColors();
        ...
        private void SetReferences()
        {
            ...
            listBillInfo = billPrintingControler.LoadBillSetingDataForSelectedObject("Restaurant_Cash_Bill");
        }
        ...
        private void txtPayAmount_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txtPayAmount.Text != "")
            {
                if (CmnFun.IsValidDecimalNo(txtPayAmount.Text.ToString()))
                {
                    ...
                    lblBalnceAmount.Text = (A - B).ToString();
                }
                else
                {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                if (txtPayAmount.Text != "")
                {
                    ...
                    if (invoiceDetails.TotalAmount <= Convert.ToDecimal(txtPayAmount.Text.ToString()))
                    {
                        ...
                        invoiceDetails.BalenceAmoun = Convert.ToDecimal(lblBalnceAmount.Text.ToString());
        ...
        private void SaveInvoice()
        {
            ...
            {
                if (saleCont.UpdateInvoicePayment(invoiceDetails, "Complete", "Cash") == true)
                {
